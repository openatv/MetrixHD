...
"""
    ...
    def getMenuItemList(self):
        ...
        list.append(getConfigListEntry(_("Show Screen-Resolution"), config.plugins.MyMetrixLiteOther.showInfoBarResolution, "ENABLED"))
        if config.plugins.MyMetrixLiteOther.showInfoBarResolution.getValue() is True:
            list.append(getConfigListEntry(_("Show extended Screen-Resolution"), config.plugins.MyMetrixLiteOther.showInfoBarResolutionExtended,))
        ...
        if config.plugins.MyMetrixLiteOther.InfoBarMoviePlayerDesign.getValue() == "2":
            list.append(getConfigListEntry(_("Show extended Screen-Resolution"), config.plugins.MyMetrixLiteOther.showMoviePlayerResolutionExtended,))

...
def Plugins(**kwargs):
	return PluginDescriptor(name="MyMetrixLite", description=_("Open Vision configuration tool for MetrixHD"), where = PluginDescriptor.WHERE_PLUGINMENU, icon="plugin.png", fnc=main)

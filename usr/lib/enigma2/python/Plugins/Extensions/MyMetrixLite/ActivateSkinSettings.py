...
#NEW			SKIN_TARGET_TMP = SKIN_TARGET + ".tmp"
			...
			colors = [
				...
				("epg-background", "#1A0F0F0F", "epgbackground", "epgbackgroundtransparency"),
				("epg-borderlines", "#1ABDBDBD", "epgborderlines", "epgborderlinestransparency"),
				...
				("epg-event-selected-foreground", "#00FFFFFF", "epgeventselectedforeground"),
				("epg-event-selected-background", "#1A27408B", "epgeventselectedbackground", "epgeventselectedbackgroundtransparency"),

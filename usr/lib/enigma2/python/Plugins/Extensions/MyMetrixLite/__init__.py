...
#global
    ...
    config.plugins.MyMetrixLiteFonts.globallarge_scale = ConfigSelectionNumber(50, 150, 1, default = 100)
...
def initOtherConfig():
    ...
    config.plugins.MyMetrixLiteOther.showEMCSelectionRows = ConfigSelection(default = "0", choices = [("0", _("No")), ("1", _("20")), ("2", _("24"))])
	#SkinDesign

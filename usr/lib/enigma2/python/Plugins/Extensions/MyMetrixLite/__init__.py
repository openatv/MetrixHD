...
def initOtherConfig():
	...
	config.plugins.MyMetrixLiteOther.SkinDesignButtonsGlossyEffect = ConfigSelection(default = "no", choices = [("no", _("None")), ("withframe", _("With Frame")), ("withoutframe", _("Without Frame")), ("gradienthalf", _("Gradient Half")), ("gradientfull", _("Gradient Full"))])

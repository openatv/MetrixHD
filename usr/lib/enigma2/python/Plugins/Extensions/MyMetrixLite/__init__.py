...
def initColorsConfig():
	...
	config.plugins.MyMetrixLiteColors.menubackgroundtransparency = ConfigSelection(default="19", choices=TransparencyList)
	config.plugins.MyMetrixLiteColors.menusymbolbackground = ConfigSelection(default="27408B", choices=ColorList)
	config.plugins.MyMetrixLiteColors.menusymbolbackgroundtransparency = ConfigSelection(default="19", choices=TransparencyList)
	config.plugins.MyMetrixLiteColors.infobarbackground = ConfigSelection(default="0F0F0F", choices=ColorList)
	config.plugins.MyMetrixLiteColors.infobarbackgroundtransparency = ConfigSelection(default="19", choices=TransparencyList)
	config.plugins.MyMetrixLiteColors.infobarprogress = ConfigSelection(default="27408B", choices=ColorList)
	config.plugins.MyMetrixLiteColors.infobarprogresstransparency = ConfigSelection(default="19", choices=TransparencyList)
	...
	config.plugins.MyMetrixLiteColors.backgroundtextbordertransparency = ConfigSelection(default="19", choices=TransparencyList)

	config.plugins.MyMetrixLiteColors.layerabackground = ConfigSelection(default="0F0F0F", choices=ColorList)
	config.plugins.MyMetrixLiteColors.layerabackgroundtransparency = ConfigSelection(default="19", choices=TransparencyList)
	...
	config.plugins.MyMetrixLiteColors.layeraselectionbackgroundtransparency = ConfigSelection(default="19", choices=TransparencyList)
	...
	config.plugins.MyMetrixLiteColors.layeraprogresstransparency = ConfigSelection(default="19", choices=TransparencyList)
	...
	config.plugins.MyMetrixLiteColors.layerbbackgroundtransparency = ConfigSelection(default="19", choices=TransparencyList)
	...
	config.plugins.MyMetrixLiteColors.layerbselectionbackgroundtransparency = ConfigSelection(default="19", choices=TransparencyList)
	...
	config.plugins.MyMetrixLiteColors.layerbprogresstransparency = ConfigSelection(default="19", choices=TransparencyList)

	config.plugins.MyMetrixLiteColors.epgbackground = ConfigSelection(default="0F0F0F", choices=ColorList)
	config.plugins.MyMetrixLiteColors.epgbackgroundtransparency = ConfigSelection(default="19", choices=TransparencyList)
	config.plugins.MyMetrixLiteColors.epgborderlines = ConfigSelection(default="BDBDBD", choices=ColorList)
	config.plugins.MyMetrixLiteColors.epgborderlinestransparency = ConfigSelection(default="19", choices=TransparencyList)
	...
	config.plugins.MyMetrixLiteColors.epgeventdescriptionbackgroundtransparency = ConfigSelection(default="19", choices=TransparencyList)
	...
	config.plugins.MyMetrixLiteColors.epgeventbackgroundtransparency = ConfigSelection(default="19", choices=TransparencyList)
	...
	config.plugins.MyMetrixLiteColors.epgprimetimebackgroundtransparency = ConfigSelection(default="19", choices=TransparencyList)
	...
	config.plugins.MyMetrixLiteColors.epgeventnowbackgroundtransparency = ConfigSelection(default="19", choices=TransparencyList)
	...
	config.plugins.MyMetrixLiteColors.epgeventselectedbackgroundtransparency = ConfigSelection(default="19", choices=TransparencyList)
	...
	config.plugins.MyMetrixLiteColors.epgservicebackgroundtransparency = ConfigSelection(default="19", choices=TransparencyList)
	...
	config.plugins.MyMetrixLiteColors.epgservicenowbackgroundtransparency = ConfigSelection(default="19", choices=TransparencyList)
	...
	config.plugins.MyMetrixLiteColors.epgtimelinebackgroundtransparency = ConfigSelection(default="19", choices=TransparencyList)
	...
	config.plugins.MyMetrixLiteColors.upperleftcornertransparency = ConfigSelection(default="19", choices=TransparencyList)
	config.plugins.MyMetrixLiteColors.lowerleftcornerbackground = ConfigSelection(default="27408B", choices=ColorList)
	config.plugins.MyMetrixLiteColors.lowerleftcornertransparency = ConfigSelection(default="19", choices=TransparencyList)
	config.plugins.MyMetrixLiteColors.upperrightcornerbackground = ConfigSelection(default="0F0F0F", choices=ColorList)
	config.plugins.MyMetrixLiteColors.upperrightcornertransparency = ConfigSelection(default="19", choices=TransparencyList)
	config.plugins.MyMetrixLiteColors.lowerrightcornerbackground = ConfigSelection(default="0F0F0F", choices=ColorList)
	config.plugins.MyMetrixLiteColors.lowerrightcornertransparency = ConfigSelection(default="19", choices=TransparencyList)
	config.plugins.MyMetrixLiteColors.optionallayerhorizontalbackground = ConfigSelection(default="27408B", choices=ColorList)
	config.plugins.MyMetrixLiteColors.optionallayerhorizontaltransparency = ConfigSelection(default="19", choices=TransparencyList)
	config.plugins.MyMetrixLiteColors.optionallayerverticalbackground = ConfigSelection(default="27408B", choices=ColorList)
	config.plugins.MyMetrixLiteColors.optionallayerverticaltransparency = ConfigSelection(default="19", choices=TransparencyList)
	...
	config.plugins.MyMetrixLiteColors.cologradient_transparencyA = ConfigSelection(default="19", choices=TransparencyList)

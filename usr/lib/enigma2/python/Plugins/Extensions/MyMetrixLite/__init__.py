...
def initOtherConfig():
	...
	config.plugins.MyMetrixLiteOther.SkinDesignButtonsGlossyEffect = ConfigSelection(default = "no", choices = [("no", _("None")), ("solidframe", _("Solid")), ("solid", _("Solid without Frame")), ("gradientframe", _("Gradient")), ("gradient", _("Gradient without Frame"))])
